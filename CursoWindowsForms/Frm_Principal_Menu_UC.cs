...
namespace CursoWindowsForms
{
    public partial class Frm_Principal_Menu_UC : Form
    {
        ...
        {
            ControleInterno += 1;
            Frm_Cadastro_UC U = new Frm_Cadastro_UC();
            U.Dock = DockStyle.Fill;
            TabPage TB = new TabPage();
            TB.Name = "Controle Interno" + ControleInterno;
            TB.Text = "Controle Interno" + ControleInterno;
            TB.ImageIndex = 7;
            TB.Controls.Add(U);
            Tbc_Aplicacoes.TabPages.Add(TB);
        }
        ...
        private void abrirImagemToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Db.InitialDirectory = "C:\\Users\\daniel.girotto\\OneDrive - INFORDOC SERVICOS DE INFORMATICA LTDA\\Desktop\\C#\\Alura\\CursoWF\\CursoWindowsForms\\Imagens";
            Db.Filter = "PNG|*.PNG";
       ...
       /* private void conectarToolStripMenuItem_Click(object sender, EventArgs e)
        ...
        private void Frm_Principal_Menu_UC_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
